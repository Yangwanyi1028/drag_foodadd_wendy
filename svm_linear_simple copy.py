...
# ==================== Configuration ====================
RANDOM_SEED = 90  # Best seed from seed_experiment.py

# 从 v4_selected_features.csv 动态读取特征（由 diagnostic_model_pipeline_v4 copy.py 生成）
features_df = pd.read_csv('seed_experiment_20260126_200935/seed_090/selected_features.csv')
SELECTED_FEATURES = features_df['Features'].tolist()
print(f"Loaded {len(SELECTED_FEATURES)} features from v4_selected_features.csv")
